...
type ModelInfo struct {
	...
	EshikRangi                      string `json:"eshik_rangi"`
	RangiEng                        string `json:"rangi_eng"`
	KorpusRangiShortname            string `json:"korpus_rangi_shortname"`
	EshikRangiShortname             string `json:"eshik_rangi_shortname"`
	RangiKodi                       string `json:"rangi_kodi"`
	...
	ManzilRu                        string `json:"manzil_ru"`
	...
	Nominal_tok_kuchi_a             string `json:"nominal_tok_kuchi_a"`
	Freon                           string `json:"freon"`
	Shovqin_darajasi_db             string `json:"shovqin_darajasi_db"`
	OdooCode                        string `json:"odoo_code"`
	Door_code                       string `json:"door_code"` // legacy; prefer freeze/ref
	Freeze_door_code                string `json:"freeze_door_code"`
	Ref_door_code                   string `json:"ref_door_code"`
